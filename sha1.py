...
def sha1Function(message):
    # Initial hash values (Digest Variables)
    h0 = 0x67452301
    h1 = 0xEFCDAB89
    h2 = 0x98BADCFE
    h3 = 0x10325476
...
# I have used 0xffffffff to make sure numbers dont go over 32..
        h0 = h0 + a & 0xffffffff
        h1 = h1 + b & 0xffffffff
        h2 = h2 + c & 0xffffffff
        h3 = h3 + d & 0xffffffff
...
# Taking input from the user and printing hashed value..
plainText = input("Enter your password : ")
sha1Hash = sha1Function(plainText)
print("Hash is : ", sha1Hash)